...
void propagate_nise_dba(t_non* non, float *H_old, float *H_new, float *e_old, float *e_new, float *re_U, float *im_U, float *cr, float *ci);
...
void thermal_correction(t_non* non, float *H_old, float *e, float *abs, int symm);
